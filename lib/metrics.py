...
#             print(self.target)
#         print(np.array2string(self.target, separator=","))
#         print(self.target)
#         print(self.output)
#         print(type_of_target(self.target))
#         print(type_of_target(self.output))
...
# #             file_perf.write("AUC PR curve: " +str(AUC_pr)
